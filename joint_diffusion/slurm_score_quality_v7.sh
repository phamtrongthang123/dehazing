#!/bin/bash
#SBATCH --job-name=score_qual_v7
#SBATCH --time=0:30:00
#SBATCH --output=/scrfs/storage/tp030/home/dehazing/slurm_logs/score_quality_v7_%N_%j.out
#SBATCH --nodes=1
...
echo ""
echo "=== PICMUS v5 score quality (fine-tune base) ==="
...
echo ""
echo "=== PICMUS v7 score quality (fine-tuned from v5 with t-importance alpha=0.3) ==="
$PYTHON -u score_quality_check.py \
    --run_dir "$V7_FILES" \
    --data_root "$DATA_ROOT" \
    --t 0.01 \
