#!/bin/bash
#SBATCH --job-name=train_picmus_v4
#SBATCH --time=2-00:00:00
#SBATCH --output=/scrfs/storage/tp030/home/dehazing/slurm_logs/train_picmus_v4_%N_%j.out
#SBATCH --nodes=1
...
echo ""
echo "=== Training PICMUS tissue v4 (channels=64, cosine LR, 1000 epochs from scratch) ==="
$PYTHON -u train.py \
    -c "configs/training/score_picmus_tissue_v4.yaml" \
